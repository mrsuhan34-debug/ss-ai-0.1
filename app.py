...
# সেটিং সিকিউর কি এবং সেশন লাইফটাইম (ব্রাউজারে সেশন একদম স্থায়ী থাকবে)
...
# রেন্ডারের ড্যাশবোর্ড থেকে ডিরেক্ট কানেক্ট হবে, ফাইল ডিলিট হওয়ার ভয় আর নেই!
...
def get_live_ai_data():
    ...
    if "cartoon" in category or "animation" in category:
        ...
        descs = ["Description: আজ রূপনগরের জাদুকরী পাখির নতুন পর্ব। Thumbnail: HD Auto-Render Complete", "Description: ভুতুড়ে বিলের গভীর রাতের কার্টুন গল্প। Thumbnail: 4K Thumbnail Loaded", "Description: চালাক শেয়ালকে উচিত শিক্ষা দিল টুনটুনি। Thumbnail: AI Frame Rendered"]
        ...
        descs = ["Description: বাংলাদেশের ঐতিহ্যবাহী রান্নার রেসিপি। Thumbnail: Food HD Close-up Ready", "Description: দ্রুত ও সহজ ভর্তা রেসিপি। Thumbnail: Cooking Step Frame Loaded", "Description: রমজানের বিশেষ ইফতার। Thumbnail: Iftar Spread Rendered"]
        ...
        descs = ["Description: বাংলাদেশের অজানা স্থান। Thumbnail: Aerial Bangladesh View Ready", "Description: सुंदरবনের অ্যাডভেঞ্চার। Thumbnail: Mangrove Forest Frame Loaded", "Description: সেন্টমার্টিনের ট্রাভেল ভ্লগ। Thumbnail: Blue Ocean Island Rendered"]
